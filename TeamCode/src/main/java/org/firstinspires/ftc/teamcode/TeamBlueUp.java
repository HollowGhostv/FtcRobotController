...
{ //AutonomoTony Inicio//
    ...
    public void loop() {    //inicio void loop
        ...
        if (odo.getHeading(AngleUnit.DEGREES) > -15 && !Step2 && ChangeStep2) {
            FL.setPower(-0.3);
            FR.setPower(0.3);
            BL.setPower(-0.3);
            BR.setPower(0.3);
        }
        else if (odo.getHeading(AngleUnit.DEGREES) <= -15 && !Step2 && ChangeStep2) {
            FL.setPower(0);
            FR.setPower(0);
            BL.setPower(0);
            BR.setPower(0);
        ...
        if (currentPos.getX(DistanceUnit.CM) < 20 && !Step3 && ChangeStep3) {
            FL.setPower(0.3);
            FR.setPower(0.3);
            BL.setPower(0.3);
            BR.setPower(0.3);
        } else if (currentPos.getX(DistanceUnit.CM) >= 20 && !Step3 && ChangeStep3)
        {
            FL.setPower(0);
            FR.setPower(0);
            BL.setPower(0);
